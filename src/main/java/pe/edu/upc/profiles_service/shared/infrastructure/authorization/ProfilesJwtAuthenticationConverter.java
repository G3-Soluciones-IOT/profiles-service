package pe.edu.upc.profiles_service.shared.infrastructure.authorization;
...
final class ProfilesJwtAuthenticationConverter {

    private ProfilesJwtAuthenticationConverter() {
    }

    static JwtAuthenticationConverter jwtAuthenticationConverter() {
        var authenticationConverter = new JwtAuthenticationConverter();
        authenticationConverter.setJwtGrantedAuthoritiesConverter(new ProfilesGrantedAuthoritiesConverter());
        return authenticationConverter;
    }

    private static final class ProfilesGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
        @Override
