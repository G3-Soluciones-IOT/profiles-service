package pe.edu.upc.profiles_service.shared.infrastructure.persistence.jpa.configuration;
...
public class FlywayMigrationConfiguration {
    ...
    private static final String FLYWAY_MIGRATOR_BEAN_NAME = "profilesFlywayMigrator";
    ...
    public InitializingBean profilesFlywayMigrator(Flyway flyway) {
        return () -> {
    ...
    @Bean
    public static BeanFactoryPostProcessor profilesEntityManagerFactoryDependsOnFlyway() {
        return beanFactory -> {
